...
def main():
    ...
    print("1. gis-maps/ksc_chicago_actual_pm25_map.html")

if __name__ == "__main__":
    main()

    print("2. gis-maps/ksc_chicago_predicted_pm25_map.html")
    print("3. gis-maps/ksc_chicago_pm25_comparison.html")
    print("\nOpen the comparison file to view side-by-side maps with performance metrics!")
